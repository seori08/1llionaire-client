...
const SCORE_FIELDS = [
  { name: "professionalism_score" as const,     label: "행사 전문성" },
  { name: "communication_score" as const,        label: "소통 및 응대" },
...
function FreelancerReviewContent() {
    ...
    <div className="animate-fade-in max-w-lg">
      <div className="mb-6">
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          함께한 의뢰인에 대한 솔직한 평가를 남겨주세요. 검수 후 공개됩니다.
        </p>
      </div>
        ...
        <Card className="mb-4">
          <CardContent className="space-y-4 pt-6">
            <label className="flex cursor-pointer items-center gap-2">
              ...
              <span className="text-sm font-medium">이 의뢰인과 다시 일하고 싶어요</span>
            </label>
            <div className="space-y-1.5">
              ...
              <Textarea
                id="comment"
                rows={4}
                placeholder="소통 방식, 현장 협조, 결제 처리 등을 자유롭게 남겨주세요"
                {...register("comment")}
              />
              {errors.comment && (
...
export default function FreelancerReviewNewPage() {
  return (
    <Suspense fallback={<div className="max-w-lg py-10 text-center text-muted-foreground">로딩 중...</div>}>
